  ...
  return (
    <Flex direction="column" position="relative" w="100%" h="100px">
      <Flex
        ...
        h="full"
      >
        <Icon onPress={setNextSong} name="backward" size={30} color="white" />
        {!isPlaying ? (
          <Flex
            style={style.shadow}
          ...
          <Flex
            ...
            height={60}
          >
            <Icon onPress={handlePause} name="pause" size={30} color="black" />
          </Flex>
        )}
        <Icon onPress={setNextSong} name="forward" size={30} color="white" />
      </Flex>
    </Flex>
  );
}
